 ...
 * @since 1.7
 */
public class SeaGlassSpinnerUI extends BasicSpinnerUI
                            implements PropertyChangeListener, SeaglassUI {
    ...
    protected void uninstallDefaults() {
        ...
        SeaGlassContext context = getContext(spinner, ENABLED);
    ...
    protected Component createPreviousButton() {
        JButton b = new SeaGlassArrowButton(SwingConstants.SOUTH);
    ...
    protected Component createNextButton() {
        JButton b = new SeaGlassArrowButton(SwingConstants.NORTH);
    ...
    public void paintBorder(SynthContext context, Graphics g, int x,
                            int y, int w, int h) {
        ((SeaGlassContext)context).getPainter().paintSpinnerBorder(context, g, x, y, w, h);
    }
    ...
    public void propertyChange(PropertyChangeEvent e) {
        ...
        if (spinnerUI instanceof SeaGlassSpinnerUI) {
            SeaGlassSpinnerUI ui = (SeaGlassSpinnerUI)spinnerUI;
